...
**WARNING**: This driver is maintenance mode. Please use [Blob CSI driver](https://github.com/kubernetes-sigs/blob-csi-driver) to access Azure blob storage in Kubernetes.
